...
Запустите пример без ключей моделей из каталога исходников: `python3 scripts/check-package.py --consumer agent`. Подробности в [быстром старте](docs/quickstart.md).
...
- **Адаптация схем:** сохраняет исходные ограничения при преобразовании схем и аргументов для каждого провайдера.
- **Явные параметры модели:** Profile и Run переопределяют настройки привязки; источник каждого параметра сохраняется.
- **Прерывание и диагностика:** сохраняет состояние приложения при восстанавливаемой остановке и позволяет просматривать сохранённые шаги со скрытыми конфиденциальными значениями.
...
- [Переход на v0.2.0](docs/migration-v0.2.md)
- [Контракты инструментов провайдеров](docs/provider-tool-schemas.md)
- [Политики прерывания](docs/interruption-policy.md)
- [Диагностика сохранённых шагов](docs/step-inspection.md)
