...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let agent = create_agent(
        ...
        AgentBindings {
            ...
            tools: None,
            system_input_resolver: None, external_receipt_verifier: None, components: None, context_sources: None, context_token_estimator: None, skills: None, artifacts: None, hooks: None,
