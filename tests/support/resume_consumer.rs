...
fn agent(
    ...
    create_agent(
        ...
        AgentBindings {
            ...
            external_receipt_verifier: None, components: None, context_sources: None, context_token_estimator: None, context_runtime: None, skills: None, artifacts: None, hooks: None,
